		...
		return this.each(function(i, e) {
			...
			var _process = function(e, feed, options) {
				...
				if (feed.description != 'Yahoo! Weather Error') {
					...
					if (options.image) html += '<div class="weatherImage" style="background-image: url(../towerwall/img/weather/'+ feed.item.condition.code+'.png); background-repeat: no-repeat;"> </div>';
					// Add item data
					if (options.city) html += '<div class="weatherCity">'+ feed.location.city +'</div>';
					if (options.country) html += '<div class="weatherCountry">'+ feed.location.country +'</div>';
					html += '<div class="weatherTemp"><p id="para">Current Temperature</p>'+ feed.item.condition.temp +'&deg;F</div>';
					html += '<div class="weatherDesc"><p id="para">Current Conditions</p>'+ feed.item.condition.text +'</div>';
				
					// Add optional data
					if(options.time) html+= '<div class="weatherTime">'+tpb+'</div>';
