...
(function($){
	...
	var _process = function(e, data, options) {
		...
		for (var i=options.offset; i<feeds.entries.length; i++) {
			...
			rowArray[rowIndex]['html'] = '<'+ options.titletag +' class="title"><a href="'+ options.linkredirect + feedLink +'" title="View this feed at '+ feeds.title +'">'+ entry.title +'</a></'+ options.titletag +'>'
			...
			if (options.content) {
				...
				rowArray[rowIndex]['html'] += '<p id="rsscontent">'+ content +'</p>'
			}
